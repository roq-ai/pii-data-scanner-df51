...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`PII Data Scanner`}</title>

        <meta
          name="description"
          content="Empower your business with PII Data Scanner - Your partner in detecting vulnerabilities and ensuring data security at every level."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1510915228340-29c85a43dcfe?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjeWJlcnNlY3VyaXR5fGVufDB8fHx8MTY5NjQ0MjEzN3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empower your business with PII Data Scanner - Your partner in detecting vulnerabilities and ensuring data security at every level.`}
            </Text>
            <Box
