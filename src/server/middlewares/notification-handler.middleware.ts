...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Support Ticket Submission.create': {
    roles: ['administrator', 'security-analyst', 'it-manager', 'compliance-officer'],
    key: 'support_ticket',
    tenantPath: [],
    userPath: [],
  },
  'Security Issue Flagged.create': {
    roles: ['administrator', 'it-manager', 'compliance-officer'],
    key: 'security_issue',
    tenantPath: [],
    userPath: [],
  },
  'System Settings Update.update': {
    roles: ['administrator', 'security-analyst', 'compliance-officer'],
    key: 'system_settings',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['administrator', 'security-analyst', 'it-manager', 'end-user', 'compliance-officer'];
